...
st.title("🕵️ AI SEO Audit Agent (Professional Report)")
...
with st.sidebar:
    ...
    st.caption("Generates: 1. Executive Summary 2. Detailed Fixes")
    ...
    if st.button("🚀 Start Professional Audit"):
        if not url_input.startswith("http"):
            ...
            if crawled_data:
                ...
                # 2. EXECUTIVE SUMMARY
                with st.status("🩺 Diagnosing Site Health...") as status:
